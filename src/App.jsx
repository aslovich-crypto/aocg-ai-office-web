    ...
    >
      ...
      >
        ...
        {/* right — сумма и под ней пилюля категории, как в макете
            ...
            maxWidth/overflow/ellipsis СНЯТЫ: справа они не работают —
            колонка не сжимается (flexShrink:0) и сама принимает ширину
            пилюли, поэтому maxWidth:100% ограничивает элемент его же
            шириной. В макете их тоже нет. */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
