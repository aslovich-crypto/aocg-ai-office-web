      ...
      {showSearch && (
        <div
          style={{
            ...
            padding: "10px 16px 22px", /* T142-воздух: до списка 22, как на «Главной» */
          }}
        >
          <div
            style={{
                    ...
                    : fnsПричина === "rejected"
                      ...
                      : fnsПричина === "unavailable"
                        ...
                        : fnsПричина === "not_found"
                          ? "Налоговая пока не отдаёт данные по этому чеку — так бывает, обычно в течение суток они появляются. Приложение исправно: сохраните чек с фото, поля можно заполнить вручную."
