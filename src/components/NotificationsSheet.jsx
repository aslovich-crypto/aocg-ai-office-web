            ...
            return (
              ...
              >
                ...
                <div style={{ minWidth: 0, flex: 1 }}>
                  {/* ⚠️ ЗДЕСЬ ТОЙ ЖЕ ДЫРЫ, ЧТО В ПИСЬМАХ, НЕТ — И ЭТО
                      ПРОВЕРЕНО, А НЕ ПРЕДПОЛОЖЕНО (10.09.2026). `title`
                      и `body` пишет человек, но React ставит их ТЕКСТОВЫМ
                      УЗЛОМ и экранирует сам; `dangerouslySetInnerHTML`
                      во всём `src/` — ноль вхождений. В письме иначе:
                      оно собирается СТРОКОЙ, и там экранирование своё
                      (`тело()` в `app/email_service.py`).
                      Правило на будущее: как только текст события пойдёт
                      в `innerHTML`, в `<title>` вкладки или в push —
                      экранирование понадобится и здесь. */}
                  <div
                    style={{
